...
export function renderNew3TemplateBody(ctx){
 ...
 const bodies={
  ...
  ribbon_path:()=>`${head('UN PARCOURS QUI VOUS RESSEMBLE')}${scene(art('n3-ribbon-flow',svg('<path d="M30 245C180 50 330 340 470 145S700 70 870 195" fill="none" stroke="currentColor" stroke-width="62" stroke-linecap="square"/>'+line('M30 245C180 50 330 340 470 145S700 70 870 195','stroke-dasharray="3 14"'), '0 0 900 300'),d.motion))}${bottom()}<div class="n3-date-line">${date}</div>`,
