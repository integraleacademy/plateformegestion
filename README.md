...
L'interface protégée est disponible sur **`/admin`**. Elle permet de scanner les sources publiques, scorer les organismes, suivre leur statut commercial, préparer un email personnalisé et exporter le pipeline au format Excel.
