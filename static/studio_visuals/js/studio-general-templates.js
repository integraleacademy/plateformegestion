...
export function createGeneralScenes(h){
 ...
 const cap=(x,y,s=1,roof=A)=>g(x,y,s,p('M-104 0 0-48 104 0 0 47Z',roof,4,roof)+p('M-62 22V70Q0 105 62 70V22',I,5,W)+p('M94 5V73',roof,6)+c(94,78,8,roof));
 ...
 const scene={
  ...
  ensemble:()=>p('M126 218Q319-22 514 218',L,9)+[180,460].map((x,i)=>human(x,285,1,i?I:A)).join('')+c(320,252,65,A)+cap(320,243,.44,I)+star(320, 90,.8)+floor()
 };
