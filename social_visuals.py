...
def generate_content_from_topic(topic):
    ...
    return {"projectTitle": title_subject[:80], "formation": formation, "recommendedRecipe": "session_announcement_6_slides", "slides": [{"role": "cover", "recommendedTemplateFamily": "editorial_cover", "content": {"eyebrow": f"FORMATION {formation}", "title": title_subject[:90], "highlightedText": formation, "introduction": f"Présentez les informations essentielles de la formation {formation} avec un message clair et utile.", "badges": [label.title(), "Formation professionnelle"], "stats": [{"label": "Formation", "value": formation, "icon": "training"}, {"label": "Lieu", "value": "Puget-sur-Argens", "icon": "location"}, {"label": "Contact", "value": "04 22 47 07 68", "icon": "phone"}], "cta": "Demander les informations"}}]}
