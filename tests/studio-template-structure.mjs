...
assert.equal(new Set(ready.map(t=>t.renderer)).size,24);
...
for(const a of ready){for(const b of ready){if(a.family!==b.family)assert.notEqual(fingerprints.get(a.id),fingerprints.get(b.id), `${a.id} vs ${b.id}`)}}
