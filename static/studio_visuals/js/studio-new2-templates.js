...
export function renderNew2TemplateBody(ctx){
  ...
  const bodies={
    ...
    new2_editorial:`<aside class="n2-editorial-rail"><span data-fit="badge">FORMATION / ${esc(formation)}</span><b>ÉDITION<br>AVENIR</b></aside><section class="n2-editorial-copy"><small>LA PREMIÈRE PAGE DE LA SUITE</small>${title}<div class="n2-editorial-bottom">${intro}${cta}</div></section><footer>${date}${location}</footer>` ,
